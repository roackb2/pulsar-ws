...
class Consumer {
    constructor(opts, logger) {
        ...
        this.wsUrl = `${opts.secure ? 'wss' : 'ws'}://${opts.host}:${opts.port}/ws/consumer/${opts.persistent ? "persistent" : "non-persistent"}/${opts.tenant}/${opts.cluster || 'default'}/${opts.namespace}/${opts.topic}/${opts.subscription}?${params}`;
