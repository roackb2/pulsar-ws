...
class Producer {
    constructor(opts, logger) {
        ...
        this.wsUrl = `${otps.secure ? 'wss' : 'ws'}://${opts.host}:${opts.port}/ws/producer/${opts.persistent ? "persistent" : "non-persistent"}/${opts.tenant}/${opts.cluster || 'default'}/${opts.namespace}/${opts.topic}?${params}`;
